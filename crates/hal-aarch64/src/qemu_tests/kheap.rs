...
fn empty_user_as_drop_cycle_does_not_block_aligned_kheap_alloc() {
    ...
    unsafe {
        ...
        test_harness_qemu::kassert_eq!(v, 0xDEAD_BEEF_CAFE_BABE);
    }
}
...
register_test!(
    KHEAP_AS_DROP_CYCLE_NO_OOM,
    "empty_user_as_drop_cycle_does_not_block_aligned_kheap_alloc",
    empty_user_as_drop_cycle_does_not_block_aligned_kheap_alloc
);
register_test!(
    KHEAP_MANY_ALIGNED_AFTER_DROPS,
    "many_aligned_kheap_allocs_after_drop_cycle_succeed",
    many_aligned_kheap_allocs_after_drop_cycle_succeed
);
