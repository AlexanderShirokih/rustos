...
fn handle_table_basic() {
    use crate::kobject::{ChannelEndpoint, Event, Handle, HandleTable, IpcError, KObject, Rights};
    ...
    qemu_test_harness::kassert!(table.get_channel(id, Rights::READ).is_ok());
    ...
    qemu_test_harness::kassert!(table.get_event(eid, Rights::WAIT).is_ok());
    qemu_test_harness::kassert!(matches!(
