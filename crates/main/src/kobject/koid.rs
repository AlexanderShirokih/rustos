...
impl<T: ?Sized> Koid<T> {
    /// Сборка из 8-битного type-tag и адреса. Tag должен быть != 0,
    /// иначе старший байт обнулится и нарушится инвариант NonZeroU64.
    pub fn from_parts(tag: u8, addr: u64) -> Self {
